...
Write-Host "Adding PersonGuid to Person.Person table..." -ForegroundColor Yellow

$addPersonGuidCommandText = "IF EXISTS(SELECT *
  FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
 WHERE TABLE_SCHEMA = 'Person'
   AND TABLE_NAME = 'Person'
   AND CONSTRAINT_NAME = 'IX_PersonPerson_PersonGuid')
BEGIN
    ALTER TABLE [Person].[Person] DROP CONSTRAINT [IX_PersonPerson_PersonGuid]
END

IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS
    WHERE TABLE_SCHEMA = 'Person'
	  AND TABLE_NAME = 'Person'
	  AND COLUMN_NAME = 'PersonGuid')
BEGIN
	ALTER TABLE [Person].[Person] DROP COLUMN [PersonGuid]
END

ALTER TABLE [Person].[Person] ADD [PersonGuid] uniqueidentifier NULL
"

$updatePersonGuidCommandText = "UPDATE [Person].[Person]
   SET [PersonGuid] = NEWID()
"

$alterPersonGuidCommandText = "ALTER TABLE [Person].[Person] ALTER COLUMN [PersonGuid] uniqueidentifier NOT NULL
ALTER TABLE [Person].[Person] ADD CONSTRAINT IX_PersonPerson_PersonGuid UNIQUE(PersonGuid)
"
...
try
{
    Write-Host "Creating PersonGuid column..." -ForegroundColor Yellow
    ExecuteCommand $addPersonGuidCommandText
    Write-Host "PersonGuid column created successfully." -ForegroundColor Green

    Write-Host "Updating PersonGuid column values..." -ForegroundColor Yellow
    ExecuteCommand $updatePersonGuidCommandText
    Write-Host "Updated PersonGuid column values successfully." -ForegroundColor Green

    Write-Host "Altering PersonGuid column..." -ForegroundColor Yellow
    ExecuteCommand $alterPersonGuidCommandText
    Write-Host "PersonGuid column altered successfully." -ForegroundColor Green
}
catch [System.Data.SqlClient.SqlException]
{
    Write-Error ([System.String]::Format("Error adding PersonGuid column: {0}", $_.Exception.Message))
    exit
}

Write-Host "Person.Person table modifications complete." -ForegroundColor Green

# SIG # Begin signature block
# MIIasQYJKoZIhvcNAQcCoIIaojCCGp4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFnTXtLpKpTxn694a7OyxoEqC
# xMmgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOnD
# Vb6Pv/F6jzP93h+shNxXJO32MFIGCisGAQQBgjcCAQwxRDBCoBqAGABwAG4AcABk
# AGEAZwBzAGMAcgBpAHAAdKEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vcHJh
# Y3RpY2VzMA0GCSqGSIb3DQEBAQUABIIBALXC9d6taa8lpmgGi0jFhoHq2y5KrBfh
# H6MT50mpEqBs90Ox+/bCWOYODLFsJAWpLzTFjAvZUdr9pOSnz+025FTbI9IG1pXu
# EWQ2e5NYlpUJZ0kvSouwi53JcA948IhSTe2IJANKSKfMr9HsSA5dLpQTASekWG86
# t/1HlXCp/kRcSRO3an86KsT15tDQfXG32P4uMkfkyLcd0EHVH0w8ZssP/oc/AbYe
# bI5hBbZUQ28xrHDvJdMECNtW8bqgBMN+cYju1UVz5JkfvIN7vzUgC/UQiw9k/gSq
# zRW55/PE5Nj4W98CA1PYUBBLYBnFjQ9/Fr6c1BwFzRlXckbIA3Eby8ehggIoMIIC
...
# CSqGSIb3DQEJBDEWBBQwXXrRd/oHXWQbLeyxi8A/DPzl+zANBgkqhkiG9w0BAQUF
# AASCAQCRFWwU4bm3TluNw69Nb/t7X4z2uACaK3rOdiyMDSIzbdf6tL48srRNizLc
# lZKMAp/o+9R40NsRXfjS/6btuzwMXslBzkEISy1zVVpduW+4WfAn2ZI6kjgIBt5M
# IIhOS3F/9Xi/8FUwW1zqvFltw8p6ovhUartbcyv9c6cYZpryalTk44QCI2nxZSDz
# ufazJj++RbCbgLYItY43yeIVnDx//pd5RDfaXuL86plcVNX7U1mF6Mebl2BifEhJ
# AF0tlyvvEoEFUHwOAAqzHrnQw3irPv0nJNU4ocHdbsqWYMfVVVroLiyVulZRpMVl
# mDWzWMJvdKpdEL6vab31lvFR13ZL
