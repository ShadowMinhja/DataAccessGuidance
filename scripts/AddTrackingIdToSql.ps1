...
Write-Host "Adding TrackingID to Sales.SalesOrderHeader tables..." -ForegroundColor Yellow

$addTrackingIdCommandText = "IF EXISTS(SELECT *
  FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
 WHERE TABLE_SCHEMA = 'Sales'
   AND TABLE_NAME = 'SalesOrderHeader'
   AND CONSTRAINT_NAME = 'IX_SalesOrderHeader_TrackingID')
BEGIN
    ALTER TABLE [Sales].[SalesOrderHeader] DROP CONSTRAINT [IX_SalesOrderHeader_TrackingID]
END

IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS
    WHERE TABLE_SCHEMA = 'Sales'
	  AND TABLE_NAME = 'SalesOrderHeader'
	  AND COLUMN_NAME = 'TrackingId')
BEGIN
	ALTER TABLE [Sales].[SalesOrderHeader] DROP COLUMN [TrackingId]
END

ALTER TABLE [Sales].[SalesOrderHeader] ADD [TrackingId] uniqueidentifier NULL
"

$updateTrackingIdCommandText = "UPDATE [Sales].[SalesOrderHeader]
   SET [TrackingId] = NEWID()
"

$alterTrackingIdCommandText = "ALTER TABLE [Sales].[SalesOrderHeader] ALTER COLUMN [TrackingId] uniqueidentifier NOT NULL
ALTER TABLE [Sales].[SalesOrderHeader] ADD CONSTRAINT [IX_SalesOrderHeader_TrackingID] UNIQUE(TrackingId)
"
...
try
{
    Write-Host "Creating TrackingId column..." -ForegroundColor Yellow
    ExecuteCommand $addTrackingIdCommandText
    Write-Host "TrackingId column created successfully." -ForegroundColor Green

    Write-Host "Updating TrackingId column values..." -ForegroundColor Yellow
    ExecuteCommand $updateTrackingIdCommandText
    Write-Host "Updated TrackingId column values successfully." -ForegroundColor Green

    Write-Host "Altering TrackingId column..." -ForegroundColor Yellow
    ExecuteCommand $alterTrackingIdCommandText
    Write-Host "TrackingId column altered successfully." -ForegroundColor Green
}
catch [System.Data.SqlClient.SqlException]
{
    Write-Error ([System.String]::Format("Error adding TrackingId column: {0}", $_.Exception.Message))
    exit
}

Write-Host "Sales.SalesOrderHeader table modifications complete." -ForegroundColor Green

# SIG # Begin signature block
# MIIasQYJKoZIhvcNAQcCoIIaojCCGp4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUB6Jo5zuyw97WrH3K1ujsbGTY
# wjSgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# JE9BqhUwNLXL6uKmAr4IlBBUMFIGCisGAQQBgjcCAQwxRDBCoBqAGABwAG4AcABk
# AGEAZwBzAGMAcgBpAHAAdKEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vcHJh
# Y3RpY2VzMA0GCSqGSIb3DQEBAQUABIIBAC3fh/b6d3I9EFW9yjWZxz8jrfoYKgtF
# thce2RPqKtVnvMQAi+6cjrs/xsmtELeGkSQfU7ebkfNONEC2F/1tGFXidbrHdpgK
# Fcem2c6jYJkRl9hxDpkbLHHlVkNvbPs5moW/ab9+CVsX7Yz04Ff6nOV6eMbzvf9K
# MNqCcKjUkfyi4wZwsFzSRNgdGGiZwvzqxyPugrPUC7uAIBGLxS/qKwabXsWeZqz7
# Qdbn8TDAN2FdoQ+zdNV59XF/0gApUAQdOTZgz5THTeKHNmkWLpBfvdPD4RzXCVAK
# TXk4CTSw9zvZGpCcYw8Fcw3jIC/Nl3dQsHR+uaCICpLhm6X74vDuawShggIoMIIC
...
# CSqGSIb3DQEJBDEWBBQtsQSvBqAOj5Lz8tzmqsfWSgO9DjANBgkqhkiG9w0BAQUF
# AASCAQBo44hfFBVvaPd/nKc6KE79Ne3082YZQFhCFXgr15RCrahaivgTdcSk6NXD
# YBMt94W59xN4T1lxX7pmsg8HaSqe1gsGMRC7n9KLLknoKE/7HXvkVHqHx1DSD5kh
# FCSS9EizJ3bT4xGQHwCemNc0naKQJ5znfwjAF1UzihyyM3ra3CVaqtCDJ3kIUxgC
# RGaOXGgd69+1sIwCVhQzVBEscdRIpkHBhr2TP8artH/l61sH0QAgODMY444kG8Ae
# dUbbvxYMVq4s+m+TsOFv4CAip+IbC7aw45ZU6U0fgFhdgMsWdCphmSgq7PEz8S9E
# HCmMhm9dxmMZzv1zO295EOBnW3Dd
