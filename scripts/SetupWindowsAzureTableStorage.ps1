...
Write-Host "Configuring Windows Azure Table Storage for shopping cart data..." -ForegroundColor Yellow
...
Write-Host "Creating Shopping cart table..." -ForegroundColor Yellow
try
{
	$azureAccount.CreateCloudTableClient().GetTableReference("ShoppingCart").CreateIfNotExists() | Out-Null
}
catch [System.Exception]
{
    Write-Error ([System.String]::Format("Error creating shopping cart table: {0}", $_.Exception.Message))
    exit
}
Write-Host "Shopping cart table created." -ForegroundColor Green
Write-Host "Windows Azure Table Storage has been configured for shopping cart data." -ForegroundColor Green
# SIG # Begin signature block
# MIIasQYJKoZIhvcNAQcCoIIaojCCGp4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUzGYNEjBRqZ8fDdTsDr5aIqMW
# IWagghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCgT
# qdDKwGWiyQDAOUdz+s0jUEeOMFIGCisGAQQBgjcCAQwxRDBCoBqAGABwAG4AcABk
# AGEAZwBzAGMAcgBpAHAAdKEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vcHJh
# Y3RpY2VzMA0GCSqGSIb3DQEBAQUABIIBAJiVkOxVIDi5xJKC9gKVc7ZkjITUQFPw
# y9bPyQI6MURT8DVW7aWMsF5O7KeG3Sp1zxLN8DO/2Dd4jGxJKON0cjFho7WtVkDR
# Ni/QR4cG2tXUd+oAUjCI2uKlG1p5bw81TQIi/FeJrcqg02MFm7Dq/2qHg3aYpY9I
# TQRqq3YW3vJpl3Bi9M5re7cguRwrA7jPnULVeoHs2xWAU3vSumLdlLGqga6tL+ma
# bBnZUI/6DNtDnD8NCzx48klrQxDcW5JoHLyHmW2rq171AdXrJgkvRgdMkpw0ZdHX
# 57eKodd6oNk3ChAO3AmQm5QdjOOZM0QD0XzVu0QoYL/HnFaWtizZAOahggIoMIIC
...
# CSqGSIb3DQEJBDEWBBQ0VzzCEUEHj/BiwuUbpU6KKkEtLzANBgkqhkiG9w0BAQUF
# AASCAQCrdEVayaMfTCcVe5Sk4iNKPDyCLZZcE+m2zkrQBq9yZjwfZGM0ozTb9XmQ
# EePbvXn5utkGc8+73QAfOLHClhIT1UklLjbYK5KHn+zxPU3hQTnwtRDBHE62Rxb8
# 6mUDh/aLMUW1BIzmElQv+aibNTACF1+g0rDOXa0GjVqpdRG+y51YlTyvWvMy2Vse
# DbFGem/ShVWZAfBniL+xB50NBFGeOiftFb8ZedUeyRsUGVrTnj8ludVYDUYqO8Sv
# WEQhQwQaJ5pW++b5CsqGnyZ0hP6DoZBtkAqnt7DC+hORYIOmPujjlc8Arq0JKEzu
# cBM9VmzhJ0iLHZDFPTmWGCb6n338
